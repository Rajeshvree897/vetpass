    ...
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $a = $('<a>', { href: src, class: "forumFile", onclick: "window.open(this.href,'blank');return false;" }).appendTo($container),
                $img = $('<img>', { src: src, id: src, title: "Download" }).appendTo($a),
            ...
            $img.attr('onerror', 'this.src="../../../images/pdf-icon.jpg"');
